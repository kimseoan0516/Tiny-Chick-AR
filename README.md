...
### 📸 AR 렌더링 결과 이미지
<!-- 아래 이미지 경로를 실제 캡처본 경로로 수정하여 사용하세요 -->
<p align="center">
  <img src="results/ar_demo.jpg" width="45%" alt="AR Demo Screenshot 1" />
  <img src="results/ar_demo_2.jpg" width="45%" alt="AR Demo Screenshot 2" />
</p>
<p align="center">
  <em>실시간 카메라 화면 위에 투영된 3D 병아리</em>
</p>

### 🎥 동작 시연 영상
<!-- 아래에 결과 영상(GIF 또는 동영상 파일)을 첨부할 수 있습니다 -->
<p align="center">
  <!-- 영상(mp4)을 직접 드래그 앤 드롭하거나, 아래처럼 gif를 첨부하세요 -->
  <img src="results/demo.gif" width="80%" alt="AR Demo Animation" />
</p>
